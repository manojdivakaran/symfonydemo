...
namespace Proxies\__CG__\CustomBookBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Category extends \CustomBookBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'CustomBookBundle\\Entity\\Category' . "\0" . 'id', 'books', '' . "\0" . 'CustomBookBundle\\Entity\\Category' . "\0" . 'name');
        }
